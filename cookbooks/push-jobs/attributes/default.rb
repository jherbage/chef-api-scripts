...
default['push_jobs']['package_url']                 = 'https://packages.chef.io/files/stable/push-jobs-client/2.4.8/ubuntu/14.04/push-jobs-client_2.4.8-1_amd64.deb'
default['push_jobs']['package_checksum']            = 'fadec562defbeeeae2cee0ce7462932b7f960c214f89f045aa6d0e67f5798c08'
...
default['push_jobs']['whitelist']                   = {
	 'bash script' => 'bash $CHEF_PUSH_JOB_FILE',
         'python script' => 'python $CHEF_PUSH_JOB_FILE',
	 'get-environment' => '/usr/bin/env',
